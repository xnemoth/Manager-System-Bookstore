...
namespace QuanLyCuaHangSach
{
    class ExportEHDN
    {
        public void ExportHDN(DataTable dt, string sheetName, string mhd, string nvl,string nvpt, string nl,string tnxb, int tt, int[,] intt)
        {
            ...
            leftnav1.Value2 = "Mã hóa đơn nhập";
            ...
            leftnav2.Value2 = "Nhân viên phụ trách";
            ...
            Microsoft.Office.Interop.Excel.Range leftnav4 = oSheet.get_Range("A10", "B10");
            leftnav4.MergeCells = true;
            leftnav4.Value2 = "Nhập từ";
            ...
            rightnav4.Value2 = tnxb;
            rightnav4.Font.Bold = true;
            ...
            footer.Value2 = "Hóa đơn này có giá trị thống kê báo cáo sách đã nhập kho";
            ...
            // nhân viên lập
            Microsoft.Office.Interop.Excel.Range f3 = (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[rowEnd + 5, columnEnd];
            Microsoft.Office.Interop.Excel.Range f4 = (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[rowEnd + 5, columnEnd + 1];
            Microsoft.Office.Interop.Excel.Range footer2 = oSheet.get_Range(f3, f4);
            footer2.MergeCells = true;
            footer2.Value2 = "Nhân viên lập";
            footer2.Font.Italic = true;
            footer2.Font.Name = "Times New Roman";
            footer2.Font.Size = "12";
            footer2.Font.ColorIndex = 10;
            footer2.HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter;
            Microsoft.Office.Interop.Excel.Range f5 = (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[rowEnd + 6, columnEnd];
            Microsoft.Office.Interop.Excel.Range f6 = (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[rowEnd + 6, columnEnd + 1];
            Microsoft.Office.Interop.Excel.Range footer3 = oSheet.get_Range(f5, f6);
            footer3.MergeCells = true;
            footer3.Value2 = nvl;
            footer3.Font.Italic = true;
            footer3.Font.Name = "Times New Roman";
            footer3.Font.Size = "12";
            footer3.Font.ColorIndex = 10;
            footer3.HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter;
        }

        public void ExportRP1(DataTable dt, string sheetName, string nvl, string nnfrom, string nnto, string ls, int tt)
        {
            Microsoft.Office.Interop.Excel.Application FE = new Microsoft.Office.Interop.Excel.Application();
            Microsoft.Office.Interop.Excel.Workbooks oBooks;
            Microsoft.Office.Interop.Excel.Sheets oSheets;
            ...
            Microsoft.Office.Interop.Excel.Range head4 = oSheet.get_Range("A5", "E5");
            head4.MergeCells = true;
            head4.Value2 = "THỐNG KÊ NHẬP KHO";
            head4.Font.Bold = true;
            head4.Font.Name = "Times New Roman";
            head4.Font.Size = "18";
            head4.Font.ColorIndex = 10;
            ...
            leftnav3.MergeCells = true;
            leftnav3.Value2 = "Loại sách nhập";
            leftnav3.Font.Bold = true;
            leftnav3.Font.Name = "Times New Roman";
            leftnav3.Font.Size = "12";
            leftnav3.Font.ColorIndex = 10;
            ...
            Microsoft.Office.Interop.Excel.Range cl2 = oSheet.get_Range("B12", "B12");
            cl2.Value2 = "Nhân viên phụ trách";
            cl2.ColumnWidth = 15.0;
            Microsoft.Office.Interop.Excel.Range cl3 = oSheet.get_Range("C12", "C12");
            cl3.Value2 = "Nhà xuất bản cung ứng";
            cl3.ColumnWidth = 15.0;
            Microsoft.Office.Interop.Excel.Range cl4 = oSheet.get_Range("D12", "D12");
            cl4.Value2 = "Ngày nhập vào";
        ...
        public void ExportRP2(DataTable dt, string sheetName, string nvl, string nvpt, string nnfrom, string nnto, string ls, int tt)
        {
            Microsoft.Office.Interop.Excel.Application FE = new Microsoft.Office.Interop.Excel.Application();
            Microsoft.Office.Interop.Excel.Workbooks oBooks;
            Microsoft.Office.Interop.Excel.Sheets oSheets;
            ...
            Microsoft.Office.Interop.Excel.Range head4 = oSheet.get_Range("A5", "E5");
            head4.MergeCells = true;
            head4.Value2 = "THỐNG KÊ CHI TIẾT NHẬP KHO";
            head4.Font.Bold = true;
            head4.Font.Name = "Times New Roman";
            head4.Font.Size = "18";
            head4.Font.ColorIndex = 10;
            ...
            Microsoft.Office.Interop.Excel.Range leftnav3 = oSheet.get_Range("A10", "B10");
            leftnav3.MergeCells = true;
            leftnav3.Value2 = "Loại sách thống kê";
            leftnav3.Font.Bold = true;
            leftnav3.Font.Name = "Times New Roman";
            leftnav3.Font.Size = "12";
            leftnav3.Font.ColorIndex = 10;
            ...
            leftnav4.MergeCells = true;
            leftnav4.Value2 = "Của nhân viên phụ trách";
            leftnav4.Font.Bold = true;
            leftnav4.Font.Name = "Times New Roman";
            leftnav4.Font.Size = "12";
            leftnav4.Font.ColorIndex = 10;
